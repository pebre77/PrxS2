...
<table border="0" cellpadding="8" cellspacing="0" style="margin: 8px" class="firstTable" >
    <tr>
        ...
        <td>
            <asp:CheckBox ID="chkFamily" class="slxlabel" runat="server" 
                Text="<%$ resources: chkFamily_rsc.Text %>" Visible="False" />&nbsp;
        </td>
        <td>
            <SalesLogix:PickListControl DisplayMode="AsControl" PickListName="Product Category"
                ID="pklProductFamily" runat="server" AlphaSort="True" AutoPostBack="False" 
                DefaultPickListItem="" LeftMargin="" Visible="False" />
        </td>
    ...
    <tr>
        <td>
            <asp:CheckBox ID="chkSKU" class="slxlabel" runat="server" Text="<%$ resources: chkSKU_rsc.Text %>" Visible="false"  />
        </td>
        <td>
        ...
        <td>
            <asp:CheckBox ID="chkStatus" class="slxlabel" runat="server" Text="<%$ resources: chkStatus_rsc.Text %>" Visible="false" /> 
        </td>
        <td>
            <SalesLogix:PickListControl DisplayMode="AsControl" PickListId="kSYST0000306" PickListName="Product Status" NoneEditable="True"
                ID="pklProductStatus" runat="server" AlphaSort="True" AutoPostBack="False" DefaultPickListItem="" LeftMargin="" Visible="false"  />
        </td>  
        <td style="padding-left: 8px;">
    ...
    <tr>
        ...
        <td align="left" valign="top" style="width: auto">
            <div style="padding: 0 10px 0 10px;">
                <asp:Label ID="lblSelectedProducts" runat="server" 
                    Text="Selected Services:" CssClass="slxlabel"></asp:Label>
                <asp:GridView CssClass="datagrid" HeaderStyle-CssClass="rowhead" AutoGenerateColumns="False" ID="grdProducts" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText='<%$ resources: TFName_rsc.HeaderText %>' HeaderStyle-Width="250px">
                            <ItemTemplate>
                                <%# Eval("Product.Name") %>
                            </ItemTemplate>
                            <ItemStyle wrap="True" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText='<%$ resources: TFFamily_rsc.HeaderText %>' HeaderStyle-Width="150px" >
                            <ItemTemplate>
                                <%# Eval("Product.Family") %>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText='<%$ resources: TFProgram_rsc.HeaderText %>' Visible="false" >
                            <ItemTemplate>
                                <%# Eval("Program") %>
                            </ItemTemplate>
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText='<%$ resources: TFPrice_rsc.HeaderText %>' Visible="false" >
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText='<%$ resources: BFDiscount_rsc.HeaderText %>' HeaderStyle-Width="65px" SortExpression="Discount" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText='<%$ resources: TFAdjPrice_rsc.HeaderText %>' Visible="false" >
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText='<%$ resources: TFAdjPriceMC_rsc.HeaderText %>' Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:BoundField DataField="Quantity" HtmlEncode="False" HeaderStyle-Width="70px" SortExpression="Quantity"
                            HeaderText='<%$ resources: BFQuatity_rsc.HeaderText %>' Visible="false" />
                        <asp:TemplateField HeaderText='<%$ resources: TFExtendedPrice_rsc.HeaderText %>' Visible="false" >
                            <ItemTemplate>
                                <SalesLogix:Currency ID="curExtPriceMC" runat="server" ExchangeRate='<%# Eval("Opportunity.ExchangeRate") %>' 
                                    ExchangeRateType="OpportunityRate" CurrentCode='<%# Eval("Opportunity.ExchangeRateCode") %>' DisplayMode="AsText"
                                    DisplayCurrencyCode="true" Text='<%# Eval("ExtendedPrice") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>   
                        <asp:TemplateField>
                            <EditItemTemplate>
