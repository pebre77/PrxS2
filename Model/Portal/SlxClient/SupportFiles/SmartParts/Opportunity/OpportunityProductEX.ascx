...
<SalesLogix:SlxGridView runat="server" ID="grdProducts" GridLines="None" AutoGenerateColumns="false" CellPadding="4" CssClass="datagrid"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Status" HeaderText="<%$ resources: grdProducts.cbdffc35-205f-4823-be00-51c2e6814177.ColumnHeading %>" SortExpression="Status" />
		<asp:BoundField DataField="OpportunityProductCI.Num" HeaderText="<%$ resources: grdProducts.76587efc-d2d6-431d-97b4-dad570949772.ColumnHeading %>" SortExpression="Quantity" />
        <asp:TemplateField HeaderText="<%$ resources: grdProducts.f2c5a5b4-9e12-4d17-bd9c-a0971a5b3f8b.ColumnHeading %>" ItemStyle-HorizontalAlign="Right" >
            <ItemTemplate>
                <SalesLogix:Currency runat="server" ID="grdProductscol5" Text='<%# dtsProducts.getPropertyValue(Container.DataItem, "OpportunityProductCI.Rate") %>' DisplayMode="AsText" ExchangeRateType="BaseRate"  />
            </ItemTemplate>
        </asp:TemplateField>
		
		
        <asp:BoundField DataField="EstimatedClose" DataFormatString="<%$ resources: grdProducts.a78eb82e-3072-4561-88c6-fcbb61b4dfca.FormatString %>" 
            HtmlEncode="false" HeaderText="<%$ resources: grdProducts.a78eb82e-3072-4561-88c6-fcbb61b4dfca.ColumnHeading %>" 
            SortExpression="EstimatedClose" ItemStyle-HorizontalAlign="Right" />

            <asp:BoundField DataField="ActualClose" DataFormatString="<%$ resources: grdProducts.a78eb82e-3072-4561-88c6-fcbb61b4dfca.FormatString %>" 
            HtmlEncode="false" HeaderText="<%$ resources: grdProducts.a78eb82e-3072-4561-88c6-fcbb61b4dfbb.ColumnHeading %>" 
            SortExpression="ActualClose" ItemStyle-HorizontalAlign="Right" />
        ...
        <asp:TemplateField HeaderText="<%$ resources: grdProducts.AdjustedPriceMC.ColumnHeading %>" ItemStyle-HorizontalAlign="Right"
		...
		<asp:ButtonField CommandName="CreateSO" Text="<%$ resources: grdProducts.4348d5bc-66e6-416a-ab26-693e8d8e3c76.Text %>"/>
