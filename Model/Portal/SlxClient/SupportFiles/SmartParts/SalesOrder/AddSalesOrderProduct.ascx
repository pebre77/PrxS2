...
<table border="0" cellpadding="8" cellspacing="0" style="margin: 8px" class="firstTable" >
    <tr>
        <td>
            <asp:CheckBox ID="chkName" class="slxlabel" runat="server" Text="Service:"/>
         </td>
         <td>
        ...
        <td>
            <asp:CheckBox ID="chkFamily" class="slxlabel" runat="server" 
                Text="<%$ resources: chkFamily.Caption %>" Visible="False"/>&nbsp;
        </td>
        <td>        
                <SalesLogix:PickListControl runat="server" ID="pklProductFamily" 
                    PickListName="Product Family" Visible="False" />            
        </td>
    ...
    <tr>
        <td>
            <asp:CheckBox ID="chkSKU" class="slxlabel" runat="server" 
                Text="<%$ resources: chkSKU.Caption %>" Visible="False"/>
        </td>
        <td>
            <asp:DropDownList ID="ddlSKU" runat="server" CssClass="slxtext" Visible="False">
                <asp:ListItem Value="0" Text="<%$ resources: ddlFilter.StartingWith.Caption %>"></asp:ListItem>
                <asp:ListItem Value="1" Text="<%$ resources: ddlFilter.Contains.Caption %>"></asp:ListItem>
                <asp:ListItem Value="2" Text="<%$ resources: ddlFilter.EqualTo.Caption %>"></asp:ListItem>
                <asp:ListItem Value="3" Text="<%$ resources: ddlFilter.NotEqualTo.Caption %>"></asp:ListItem>
            ...
            <asp:TextBox ID="txtSKU" runat="server" Visible="False"></asp:TextBox>
        </td>
        <td>
            <asp:CheckBox ID="chkStatus" class="slxlabel" runat="server" 
                Text="<%$ resources: chkStatus.Caption %>" Visible="False"/> 
        </td>
        <td>            
                <SalesLogix:PickListControl runat="server" ID="pklProductStatus" 
                    PickListName="Product Status" Visible="False"/>
        </td>  
        <td style="padding-left: 30px;">
    ...
    <tr>
       <td colspan="2">
            <asp:CheckBox AutoPostBack="True" class="slxlabel" ID="chkPackage" 
                style="white-space:nowrap" runat="server" 
                Text="<%$ resources: chkPackage.Caption %>" 
                OnCheckedChanged="chkPackage_CheckedChanged" Visible="False" />
        </td>
        <td colspan="3">&nbsp;</td>
    </tr>
</table><br />
            ...
            <div style="padding: 0 10px 0 10px;">
                ...
                <asp:GridView CssClass="datagrid" HeaderStyle-CssClass="rowhead" ID="grdProducts" runat="server" BorderWidth="0" GridLines="None"
                   ...
                   <%-- TODO: Neet to extend Sales Order to include Sort  --%>
                        ...
                        <asp:TemplateField HeaderText="<%$ resources: grdProducts.Name.ColumnHeader %>" HeaderStyle-Width="250px">
                            <ItemTemplate>
                                <%# Eval("ProductName") %>
                            </ItemTemplate>
                            <ItemStyle wrap="True" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="<%$ resources: grdProducts.Family.ColumnHeader %>" HeaderStyle-Width="150px">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ resources: grdProducts.PriceLevel.ColumnHeader %>" Visible="False">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ resources: grdProducts.Price.ColumnHeader %>" ItemStyle-HorizontalAlign="Right" Visible="False">
                            <ItemTemplate>
                        ...
                        <asp:BoundField DataField="Discount" HtmlEncode="False" HeaderStyle-Width="65px" HeaderText="<%$ resources: grdProducts.Discount.ColumnHeader %>"
                            DataFormatString="{0:p}" SortExpression="Discount" ItemStyle-HorizontalAlign="Right" Visible="False" />
                        <asp:TemplateField HeaderText="<%$ resources: grdProducts.AdjustedPrice.ColumnHeader %>" ItemStyle-HorizontalAlign="Right" Visible="False">
                            <EditItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ resources: grdProducts.ExtendedPrice.ColumnHeader %>" ItemStyle-HorizontalAlign="Right" Visible="False">
                            <ItemTemplate>
