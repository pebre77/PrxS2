    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        foreach (string productID in selectedProductIDs)
        {
            ...
            if (product != null)
            {
				...
				ISalesorderdetail sod = EntityFactory.Create<ISalesorderdetail>();
                sod.Accountid = salesOrder.Account.Id.ToString();
                sod.Product = EntityFactory.GetRepository<IProduct>().Get(productID);
                sod.Status = null;
                sod.Unit = null;
                sod.Description = null;
                sod.Program = null;
                sod.Warehouselocation = null;
                sod.Quantityordered = null;
                sod.Cost = null;
                sod.Extendedprice = null;
                sod.Extendedpriceinvoiced = null;
                sod.Linenumber = null;
                sod.Quantityshipped = null;
                sod.ProductcostId = null;
                sod.PriceeffDate = null;
                sod.Notes = null;
                sod.Errormessage = null;
                sod.TransmitDate = null;
                sod.Priceadjusted = null;
                sod.Calcprice = null;
                sod.ShippedDate = null;
                sod.SalesOrder = salesOrder;
